...
//         <div
//           className="h-full bg-gradient-to-r from-gray-800 to-gray-900 transition-all duration-100"
...
//       <button
//         onClick={prev}
//         className="absolute left-4 top-1/2 -translate-y-1/2 p-3 bg-white rounded-full shadow"
//       >
//         <FiChevronLeft />
//       </button>
...
//       <button
//         onClick={next}
//         className="absolute right-4 top-1/2 -translate-y-1/2 p-3 bg-white rounded-full shadow"
//       >
//         <FiChevronRight />
//       </button>
...
//           className="max-w-4xl bg-white rounded-3xl shadow-xl p-10"
//         >
//           {/* title */}
//           {current.title && (
