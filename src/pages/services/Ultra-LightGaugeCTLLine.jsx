...
export default function EurocutPrecisionCTL800() {
  ...
  return (
    <div className="bg-slate-950 text-white antialiased overflow-x-hidden">
      {/* HERO */}
      <section className="relative min-h-[90vh] md:h-screen flex items-center justify-center overflow-hidden px-4">
        <motion.img
          initial={{ scale: 1.1 }}
          animate={{ scale: 1 }}
          transition={{ duration: 8, repeat: Infinity, repeatType: "reverse" }}
        ...
        <div className="relative z-10 text-center max-w-4xl px-4">
          ...
          <p className="text-base sm:text-lg md:text-2xl text-zinc-300 mb-8">
            Micron-level precision for ultra-light gauge materials
          </p>

          <motion.a
            href="#features"
            className="inline-flex items-center gap-3 bg-white text-black px-6 sm:px-8 md:px-10 py-3 sm:py-4 md:py-5 rounded-2xl font-semibold text-sm sm:text-base md:text-lg hover:bg-cyan-400 transition-all"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.98 }}
          >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 md:gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                whileHover="hover"
                whileTap="hover"
                className="group min-h-[320px] sm:min-h-[360px] md:h-[420px] perspective-1000 cursor-pointer"
              >
                <motion.div
                ...
                >
                  {/* FRONT */}
                  <div className="absolute inset-0 backface-hidden bg-slate-800 border border-slate-700 rounded-3xl p-5 sm:p-6 md:p-8 flex flex-col">
                    <div className={`w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-2xl bg-gradient-to-br ${feature.color} flex items-center justify-center text-black mb-6`}>
                      {feature.icon}
                    </div>

                    <div className="text-4xl sm:text-5xl md:text-6xl font-bold text-cyan-400/20 mb-3">
                    ...
                    <div className="mt-auto text-cyan-400 text-sm flex items-center gap-2">
                      Hover / Tap to flip <ArrowRight className="w-4 h-4" />
                    </div>
                  </div>

                  {/* BACK */}
                  <div className="absolute inset-0 backface-hidden bg-gradient-to-br from-slate-800 to-slate-900 border border-cyan-400/30 rounded-3xl p-5 sm:p-6 md:p-8 flex flex-col rotateY-180 overflow-auto">
